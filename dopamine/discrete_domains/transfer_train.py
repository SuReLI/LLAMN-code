...
from dopamine.discrete_domains import transfer_run_experiment
...
def get_base_dir(resume, ckpt_dir):
  if resume:
    ...
    path = os.path.join(FLAGS.base_dir, 'Transfer_*')
    ...
    expe_time = 'Transfer_' + datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
...
def main(unused_argv):
  ...
  runner = transfer_run_experiment.MasterRunner(base_dir, not FLAGS.no_parallel)
